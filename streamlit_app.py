...
st.markdown("""
<p class="intro-text">
这是一个由 <strong>ColdOS</strong> 驱动的AI对话监控演示。当您与AI自由对话时，右侧的仪表盘将实时可视化它的'认知状态'——它的信念是否稳定？回答是否自洽？是否在迎合您？ColdOS 作为智能体的运行时内核，正在持续守护着每一次交互的'一致性'。
</p>
""", unsafe_allow_html=True)
...
st.markdown("---")
st.markdown("ColdOS 防谄媚场景集成框架 © 2026 | 运行时认知状态监控平台")